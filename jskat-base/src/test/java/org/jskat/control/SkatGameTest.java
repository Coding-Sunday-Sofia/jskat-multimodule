...
public class SkatGameTest extends AbstractJSkatTest {
    ...
    public void playerPlaysNotAllowedCard() {
        ...
        final SkatGameResult gameResult = game.getGameResult();
        assertTrue(gameResult.isSchwarz());
        assertThat(gameResult.getFinalDeclarerPoints() + gameResult.getFinalOpponentPoints(), is(120));
    }
    ...
    public void testCompleteGame() {
        ...
        if (declarer != null && result.getGameValue() > 0) {
            ...
            final Map<Player, Integer> playerPointsInTricks = new HashMap<Player, Integer>();
    ...
    public void testPredefinedCardPlaying() {
        ...
        final CardDeck deck = new CardDeck("SJ CA CT CK C9 C7 H8 DK DQ D7",
    ...
    public void testGameResultIssue33() {
        ...
        final CardDeck deck = new CardDeck("CJ SJ SA ST S9 S8 S7 C9 C7 D8",
