...
public class TrickCardPlayedEventTest extends AbstractJSkatTest {
    ...
    public void skatGameDataBeforeEvent() {
        ...
        final List<TrickCardPlayedEvent> reverseEventList = new ArrayList<TrickCardPlayedEvent>(
                eventList);
    ...
    private static void assertTrick(final Trick trick, final Card firstCard, final Card secondCard,
