...
public class CardDealEventTest extends AbstractJSkatTest {
    ...
    public void setUp() {
        ...
        playerCards.put(Player.FOREHAND, new CardList(Arrays.asList(Card.CJ, Card.SJ, Card.HJ, Card.DJ)));
        playerCards.put(Player.MIDDLEHAND, new CardList(Arrays.asList(Card.CA, Card.SA, Card.HA, Card.DA)));
        playerCards.put(Player.REARHAND, new CardList(Arrays.asList(Card.CT, Card.ST, Card.HT, Card.DT)));
    ...
    public void equalsAndHashCode() {
        EqualsVerifier.forClass(CardDealEvent.class).verify();
    }
