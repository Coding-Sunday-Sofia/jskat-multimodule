...
public class RamschRuleTest extends AbstractJSkatTest {
    ...
    public void testWrongGameData_NoAnnouncement() {
        ...
        assertThrows(IllegalStateException.class, () -> data.getRamschLoosers());
    }
    ...
    public void testCalcGameValue_ForeHandMostPoints() {
        ...
        final Set<Player> ramschLoosers = data.getRamschLoosers();
    ...
    private void assertFalse(final boolean gameWon) {
    }
