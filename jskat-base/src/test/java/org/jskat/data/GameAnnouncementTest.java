...
public class GameAnnouncementTest extends AbstractJSkatTest {
    ...
    public static void createAllValidGameAnnouncements() {
        ...
        for (final GameType suitGrand : Arrays.asList(GameType.GRAND, GameType.CLUBS, GameType.SPADES, GameType.HEARTS, GameType.DIAMONDS)) {
    ...
    private static void testAnnouncement(final GameAnnouncement announcement,
        ...
        if (isValidAnnouncement(announcement)) {
            ...
            assertFalse(validAnnouncements.contains(ann), "Not in valid set or created as null object: " + ann);
            assertNull(announcement, "Wrong created announcement: " + announcement);
        }
    }
