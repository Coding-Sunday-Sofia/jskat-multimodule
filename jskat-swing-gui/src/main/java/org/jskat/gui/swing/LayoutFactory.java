...
public class LayoutFactory {
     ...
     * @return Layout manager
     */
    public static MigLayout getMigLayout(final String layoutConstraints) {
     ...
     */
    public static MigLayout getMigLayout(final String layoutConstraints,
                                         final String columnConstraints, final String rowConstraints) {
    ...
    private static String injectMacOSLayoutConstraints(final String layoutConstraints) {
