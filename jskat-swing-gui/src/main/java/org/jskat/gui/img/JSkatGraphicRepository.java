...
public class JSkatGraphicRepository {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(JSkatGraphicRepository.class);
    ...
    public static String getImageFileName(final Card card) {

        return (card.getSuit().getShortString() + "-" + card.getRank().getShortString());
    }

    private static String getCardSetNameInLowerCase(final CardSet set) {
